    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <p style="color: rgb(19,14,242);padding: 10px 25px;font-size: 25px;line-height: 25px;letter-spacing: 2px;font-weight: bold;text-shadow: 1px 1px 0px rgb(101,99,53);margin-bottom: 0px;">
                <img src="{{ asset('assets/img/news.png') }}" style="width: 25px;margin-right: 15px;">Nyhetsledelse
            </p>
            <hr style="margin-top: 4px;">
            <div id="content">

                <div class="container-fluid">
                    <h1 class="text-dark mb-4" style="font-size:16px;margin-top:20px;">Nyhetsledelse</h1>
					<hr>
                    <div class="card shadow" style="margin-bottom: 20px;">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Legg til Nyheter</p>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        <form action="/godisHusetmyadmin/news/add" method="post">
                                            @csrf
                                            <tr>
                                                <td>
                                                    <label for="news">Tittel</label>
                                                    <textarea name="news"  style="width: 100%;height:80px;padding:5px;" required></textarea></td>
                                                <td>
                                                ...
                                                <td>
                                                    <button class="btn btn-success btn-icon-split" role="button" style="margin-top:20px;">
                                                        ...
                                                        <span class="text-white text">Legg til Nyheter</span>
                                                    </button>
                                                </td>
                                            </tr>
                                        </form>
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Slett Nyhet</p>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/godisHusetmyadmin/news/remove/{{ $ct->id }}" class="btn btn-danger btn-icon-split" role="button"><span class="text-white-50 icon"><i class="fas fa-trash"></i></span><span class="text-white text">Slett</span></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
