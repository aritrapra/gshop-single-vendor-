...
<body style="overflow: hidden;">
    ...
    <div class="row" style="margin-top: 0px;">
        <div class="col">
            ...
            <hr>
            <div style="height: calc(100vh - 235px);overflow-y: scroll;scroll-behavior: revert;scrollbar-width: none;display:flex;flex-direction: column-reverse;">
                @foreach ($data as $ct)
                    @php
    ...
    .msg{
        font-size: 14px;
            ...
            <div style="background-color:white;">
                <form action="/postmsg/{{ $id }}" method="post">
                    @csrf
